...
RUN if [ "$MODEL_TYPE" = "sdxl" ]; then \
    ...
    elif [ "$MODEL_TYPE" = "wan21-t2v" ]; then \
      wget -O models/diffusion_models/wan2.1_t2v_14B_fp16.safetensors https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_t2v_14B_fp16.safetensors && \
